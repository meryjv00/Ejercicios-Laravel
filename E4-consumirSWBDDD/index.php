...
<html>
    ...
    <body>
        ...
        //$ch = curl_init("http://localhost:9090/EjemplosLaravel/ejemploBBDD/public/servicioWEB");
        $ch = curl_init("http://localhost:9090/EjemplosLaravel/ejemploBBDD/public/servicioWEBdatosRuta/2B");
        //$ch = curl_init("http://localhost:9090/EjemplosLaravel/ejemploBBDD/public/servicioWEB?dni=4D");
...
//        $data = ["dni" => '1A'];
//        //url contra la que atacamos
//        $ch = curl_init("http://localhost/EjemplosLaravel/E4-ejemploBBDD-Vold/public/servicioWEBPost/1A");
//        //a true, obtendremos una respuesta de la url, en otro caso, 
//        //true si es correcto, false si no lo es
//        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
//        //establecemos el verbo http que queremos utilizar para la peticiÃ³n
